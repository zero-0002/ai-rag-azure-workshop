...
Let's understand the shape of the data available to us - and think proactively about how you could bring _your data_ into this mix.
...
??? quote "SAMPLE DATA (JSON) - _click to expand_" 
...
??? quote "SAMPLE RECORD (Markdown) - _click to expand_" 
...
??? quote "SAMPLE RECORD (CSV) - _click to expand_" 
